...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) #Tells us the path to the root of the django project (where manage.py is)
...
SECRET_KEY = '=$yh(6gz$+^8m-=mqsblpv)*wm4qtsb@nw1opy8st_2ffw5_w^'
